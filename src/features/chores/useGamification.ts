...
// L'octroi (+10 à chaque palier de 7 jours d'affilée) est fait CÔTÉ SERVEUR par
// la RPC log_chore (atomique, ancré Europe/Paris, dédup 1/membre/jour, ref_id =
// log déclencheur repris au undo) — voir migration 20260721000000. Le client ne
// garde que la constante pour l'affichage du toast.
