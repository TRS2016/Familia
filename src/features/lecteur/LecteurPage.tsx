...
import {
  ...
  Repeat, Repeat1, Moon, Star, PartyPopper, ListPlus, Share2, Check,
} from 'lucide-react'
...
// ── YouTubeSearchModal (membre : recherche → ajout bibliothèque) ──────────────
...
function YouTubeSearchModal({ onClose, onAdd }: {
  onClose: () => void
